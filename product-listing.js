let products = [
  ...
  },
  {
    ...
    display: "listingpage",
    selflife: "12 months",
    description: "Long Lasting moisturisation.The Nivea Deep Moisture Serum formula gives you moisturised skin for up to 48 hours, Natural Ingredients.Almond oil and vitamin E nourish & repair the skin from deep within.Ideal for daily use.It effectively transforms very dry skin to healthy, smooth skin.",
  ...
  },
  {
    ...
    display: "listingpage",
    selflife: "12 months",
    description: "Original cola flavour: Savor the refreshing cola flavor that is deliciously uplifting.Turn up the energy: Turn up the energy with the delicious and refreshing taste of coca-cola original.Make meals tastier: Meals become tastier with coca-cola original.Best enjoyed: Coca-cola is best enjoyed ice-cold for maximum refreshment.Create and enjoy moments: Enjoy it with family, friends and relive the joy of togetherness.Perfect size: Enjoy coca-cola’s crisp, delicious taste on-the-go, with meals or at parties.Recyclable packaging: Coca-cola cans are 100% recyclable, ensuring environmental sustainability.",
